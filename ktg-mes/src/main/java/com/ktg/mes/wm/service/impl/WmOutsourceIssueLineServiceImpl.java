...
public class WmOutsourceIssueLineServiceImpl implements IWmOutsourceIssueLineService 
{
     ...
     */
    @Override
    public List<WmOutsourceIssueLine> selectWmOutsourceIssueLineWithDetailList(WmOutsourceIssueLine wmOutsourceIssueLine) {
        return wmOutsourceIssueLineMapper.selectWmOutsourceIssueLineWithDetailList(wmOutsourceIssueLine);
    }
