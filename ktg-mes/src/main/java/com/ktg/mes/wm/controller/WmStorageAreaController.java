...
public class WmStorageAreaController extends BaseController
{
    ...
    {
        WmBarcode param = new WmBarcode();
        param.setBussinessId(wmStorageArea.getAreaId());
        param.setBarcodeType(UserConstants.BARCODE_TYPE_STORAGEAREA);
        WmBarcode barcode = barCodeUtil.getBarcodeByBussinessObj(param);
    ...
    public AjaxResult getLocationName(WmStorageArea area){
        return wmStorageAreaService.getLocationName(area);
    }
}
