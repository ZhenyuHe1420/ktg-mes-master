...
public class WmRtSalesController extends BaseController
{
    ...
    @PostMapping("/export")
    public void export(HttpServletResponse response, WmRtSales wmRtSales)
    {
        List<WmRtSales> list = wmRtSalesService.selectWmRtSalesList(wmRtSales);
    ...
    public AjaxResult add(@RequestBody WmRtSales wmRtSales)
    {
        ...
        return toAjax(wmRtSalesService.insertWmRtSales(wmRtSales));
    }
    ...
    public AjaxResult remove(@PathVariable Long[] rtIds)
    {
        for (Long rtId: rtIds
            ...
            if(UserConstants.ORDER_STATUS_PREPARE.equals(wmRtSalesService.selectWmRtSalesByRtId(rtId).getStatus())){
