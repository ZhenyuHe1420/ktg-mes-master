...
public class WmBarCodeUtil {
    ...
    public WmBarcode getBarcodeByBussinessObj(WmBarcode obj){
        WmBarcode barcode = new WmBarcode();
        barcode.setBarcodeFormart(obj.getBarcodeFormart());
        barcode.setBarcodeType(obj.getBarcodeType());
        barcode.setBarcodeContent(obj.getBarcodeContent());
        barcode.setBussinessId(obj.getBussinessId());
        barcode.setBussinessCode(obj.getBussinessCode());
        barcode.setEnableFlag(UserConstants.YES);
        List<WmBarcode> barcodes = wmBarcodeService.selectWmBarcodeList(barcode);
