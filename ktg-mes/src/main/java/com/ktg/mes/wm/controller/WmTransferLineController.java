...
public class WmTransferLineController extends BaseController
{
    ...
    public TableDataInfo listWithDetail(WmTransferLine wmTransferLine)
    {
        startPage();
    ...
    {
        if(StringUtils.isNotNull(wmTransferLine.getWarehouseId())){
            WmWarehouse warehouse = wmWarehouseService.selectWmWarehouseByWarehouseId(wmTransferLine.getWarehouseId());
            wmTransferLine.setWarehouseCode(warehouse.getWarehouseCode());
            wmTransferLine.setWarehouseName(warehouse.getWarehouseName());
        }
        if(StringUtils.isNotNull(wmTransferLine.getLocationId())){
            WmStorageLocation location = wmStorageLocationService.selectWmStorageLocationByLocationId(wmTransferLine.getLocationId());
            wmTransferLine.setLocationCode(location.getLocationCode());
            wmTransferLine.setLocationName(location.getLocationName());
        }
        if(StringUtils.isNotNull(wmTransferLine.getAreaId())){
            WmStorageArea area = wmStorageAreaService.selectWmStorageAreaByAreaId(wmTransferLine.getAreaId());
            wmTransferLine.setAreaCode(area.getAreaCode());
            wmTransferLine.setAreaName(area.getAreaName());
        }
