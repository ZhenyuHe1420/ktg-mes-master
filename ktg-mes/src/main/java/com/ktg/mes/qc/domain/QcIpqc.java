...
public class QcIpqc extends BaseEntity
{
    ...
    private BigDecimal quantityLaborScrap;

    private BigDecimal quantityMaterialScrap;

    private BigDecimal quantityOtherScrap;
    ...
    public BigDecimal getQuantityLaborScrap() {
        return quantityLaborScrap;
    }

    public void setQuantityLaborScrap(BigDecimal quantityLaborScrap) {
        this.quantityLaborScrap = quantityLaborScrap;
    }

    public BigDecimal getQuantityMaterialScrap() {
        return quantityMaterialScrap;
    }

    public void setQuantityMaterialScrap(BigDecimal quantityMaterialScrap) {
        this.quantityMaterialScrap = quantityMaterialScrap;
    }

    public BigDecimal getQuantityOtherScrap() {
        return quantityOtherScrap;
    }

    public void setQuantityOtherScrap(BigDecimal quantityOtherScrap) {
        this.quantityOtherScrap = quantityOtherScrap;
    }
